...
MICAF = ['19990223'] # 'mica_calibration'  # 'mica_hourly' #'mica_vs_master' # ['19990222']
...
OPATH = REPO_PATH + '/output/mica_uncalibrated'
...
if MICAF == 'mica_vs_master':
    ...
    for var in COL_NAMES:
        ...
        elif var == 'Sky_T_over_Sun_T':
            plt.hist(y, log=True, bins=NBINS, range=(0,5), color='k', histtype='step')
        else:
